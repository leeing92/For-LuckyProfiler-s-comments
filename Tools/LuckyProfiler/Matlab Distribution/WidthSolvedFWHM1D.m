...
%         [cfun,gof]=fit(px*xx_spand',L_expand',matfit,'StartPoint',[gaussfit.c1-px,(nn-1)*px,0,0],'Lower',[0 0 0 0 ],'Upper',[gaussfit.c1,Nmax*px,1,Inf],'Normalize','off');
%         [cfun,gof]=fit(xx_spand',L_expand',matfit,'StartPoint',[1,nn,0,0],'Normalize','off');
...
%         FitResultTemp=(WithWidth1D(cfun.sigma,cfun.r,cfun.b,cfun.A,xx0)-L).^2;
%         WidthFit_e(nn)=sum(FitResultTemp);
